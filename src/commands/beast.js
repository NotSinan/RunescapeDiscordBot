            ...
            .then(async (beastData) => {
                const beastEmbed = new EmbedBuilder()
                    ...
                    .addFields(
                        ...
                        {
                            name: 'Ranged',
                            value: `${beastData.ranged}`,
                            inline: true,
                        },
                        {
                            name: 'Attack',
                            value: `${beastData.attack}`,
                            inline: true,
                        }
                    )
                    .addFields(
                ...
                await interaction.editReply({ embeds: [beastEmbed] })
            })
